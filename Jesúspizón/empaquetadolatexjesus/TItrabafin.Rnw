...
<<echo=FALSE>>=
leyes = read.csv("h:/TendecSoftw/ProyFinal/leyes1968a2015c2.csv", header=T, sep=";")

leyes1 = read.csv("h:/TendecSoftw/ProyFinal/leyes1968a1991.csv", header=T, sep=";")

leyes2 = read.csv("h:/TendecSoftw/ProyFinal/leyes1992a2015.csv", header=T, sep=";")
...
<<echo=FALSE,fig=TRUE>>=
barplot(leyes1[ ,2], names.arg = leyes1[ ,1], main="Leyes de Colombia (1968 a 1991)", ylim=c(10,140),xlab="Anual", ylab="Cant.Leyes", col=c(1, 2, 3, 4,5,6,7,8))
@

% crea el diagrama de barras de las leyes de Colombia 1992 a 2015
<<echo=FALSE,fig=TRUE>>=
barplot(leyes2[ ,2], names.arg = leyes2[ ,1], main="Leyes de Colombia (1992 a 2015)", ylim=c(10,140),xlab="Anual", ylab="Cant.Leyes", col=c(1, 2, 3, 4,5,6,7,8))
@    
